...
const int _kMaxDroppedSwipePageForwardAnimationTime = 200; // Milliseconds.
const int _kMaxDroppedSwipePageForwardAnimationTimeIOS = 400;
// The maximum time for a page to get reset to it's original position if the
// user releases a page mid swipe.
const int _kMaxPageBackAnimationTime = 150; // Milliseconds.
const int _kMaxPageBackAnimationTimeIOS = 400;

const int _transitionDuration = 150;
const int _transitionDurationIOS = 400;
...
final Animatable<Offset> _kMiddleLeftTweenIOS = Tween<Offset>(
  begin: Offset.zero,
  end: const Offset(-1.0, 0.0),
);
final Animatable<double> _test = Tween<double>(
  begin: 1.0,
  end: 0.2,
);
...
class CupertinoPageTransition extends StatelessWidget {
    ...
    @required bool linearTransition,
        ...
        _secondaryPositionAnimation = (linearTransition
          ...
          reverseCurve: Curves.easeInToLinear,
            ...
            .drive(Platform.isIOS ? _kMiddleLeftTweenIOS : _kMiddleLeftTween),
        ...
        enterPage = primaryRouteAnimation,
        exitPage = secondaryRouteAnimation,
        super(key: key);

  final Animation<double> enterPage;
  final Animation<double> exitPage;
  ...
  Widget build(BuildContext context) {
    ...
    return exitPagePlatformAnimation(
      parent: exitPage,
      child: SlideTransition(
        position: _secondaryPositionAnimation,
        textDirection: textDirection,
        transformHitTests: false,
        child: enterPagePlatformAnimation(
          parent: enterPage,
          child: SlideTransition(
  ...
  exitPagePlatformAnimation(
      {@required Animation<double> parent, @required Widget child}) {
    if (Platform.isIOS) {
      return FadeTransition(
          opacity: CurvedAnimation(
              parent: parent.drive(_test),
              curve: Curves.linear,
  ...
  void dragEnd(double velocity) {
    ...
    if (animateForward) {
      ...
      final int droppedPageForwardAnimationTime = min(
        lerpDouble(
            Platform.isIOS
                ? _kMaxDroppedSwipePageForwardAnimationTimeIOS
                : _kMaxDroppedSwipePageForwardAnimationTime,
            0,
            controller.value)
            .floor(),
        Platform.isIOS
            ? _kMaxPageBackAnimationTimeIOS
